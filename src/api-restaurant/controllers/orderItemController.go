...
func ItemsByOrder(id string) (OrderItems []primitive.M, err error) {
	...
	lookupStage := bson.D{{"$lookup", bson.D{{"from", "dish"}, {"localField", "dish_id"}, {"foreignField", "dish_id"}, {"as", "dish"}}}}
	unwindStage := bson.D{{"$unwind", bson.D{{"path", "$dish"}, {"preserveNullAndEmptyArrays", true}}}}
...
func UpdateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if orderItem.Dish_id != nil {
			updateObj = append(updateObj, bson.E{"dish_id", *orderItem.Dish_id})
		}
